# [SOLVED] How Do I Make A Batch File Terminate Upon Encountering An Er
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/how-do-i-make-a-batch-file-terminate-upon-encountering-an-er)

---

### 🔍 Quick Technical Overview & Summary:
Use the `exit /b` command to terminate the batch file immediately if an error code is encountered.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/how-do-i-make-a-batch-file-terminate-upon-encountering-an-er)**
